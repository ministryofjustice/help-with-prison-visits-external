...
describe('services/domain/about-you', function () {
  ...
  it('should construct a domain object given valid input', function () {
    ...
    expect(aboutYou.nationalInsuranceNumber, 'should uppercase').to.equal(VALID_NATIONAL_INSURANCE_NUMBER.replace(/ /g, '').toUpperCase())
    ...
    expect(aboutYou.postCode, 'should uppercase').to.equal(VALID_POSTCODE.toUpperCase())
