...
describe('services/domain/payment-details', function () {
  ...
  it('should construct a domain object given valid input', function () {
    paymentDetails = new PaymentDetails(VALID_PAYMENT_BANK, VALID_ACCOUNT_NUMBER, VALID_SORT_CODE)
  ...
  it('should construct a domain object given a sort code with hyphens', function () {
    ...
    paymentDetails = new PaymentDetails(VALID_PAYMENT_BANK, VALID_ACCOUNT_NUMBER, sortCodeWithHyphens)
    expect(paymentDetails.accountNumber).to.equal(PROCESSED_ACCOUNT_NUMBER)
  ...
  it('should construct a domain object given a sort code with hyphens and spaces', function () {
    ...
    paymentDetails = new PaymentDetails(VALID_PAYMENT_BANK, VALID_ACCOUNT_NUMBER, sortCodeWithHyphensAndSpaces)
    expect(paymentDetails.accountNumber).to.equal(PROCESSED_ACCOUNT_NUMBER)
  ...
  it('should throw a ValidationError if given letters', function () {
    expect(function () {
      new PaymentDetails(VALID_PAYMENT_BANK, 'asdf', 'asdf')
    }).to.throw(ValidationError)
  })

  it('should throw a ValidationError if given invalid length inputs', function () {
    expect(function () {
      new PaymentDetails(VALID_PAYMENT_BANK, '123456789', '123')
    }).to.throw(ValidationError)
  })
})
