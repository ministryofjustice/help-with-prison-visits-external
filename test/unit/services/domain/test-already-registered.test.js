...
describe('services/domain/already-registered', () => {
  ...
  it('should construct a domain object given valid input', () => {
    const alreadyRegistered = new AlreadyRegisterd(VALID_REFERNCE, VALID_DAY, VALID_MONTH, VALID_YEAR)
  ...
  it('should throw an error if passed invalid data', () => {
    expect(() => {
      new AlreadyRegisterd(INVALID_REFERNCE, VALID_DAY, VALID_MONTH, VALID_YEAR).isValid()
    }).toThrow()
  })
})
