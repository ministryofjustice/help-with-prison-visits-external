...
describe('services/domain/about-you', () => {
  ...
  it('should throw a ValidationError if given invalid input', () => {
    expect(() => {
      new AboutYou('', '', '', '', '', '', '', '', '', '', '', '', '')
    }).toThrow()
  })
  ...
  it('should throw a ValidationError if an invalid National Insurance Number is provided as input', () => {
    expect(() => {
      aboutYou = new AboutYou(
        VALID_DOB,
        VALID_RELATIONSHIP,
  ...
  it('should throw a ValidationError if an invalid PostCode is provided as input', () => {
    expect(() => {
      new AboutYou(
        VALID_DOB,
        VALID_RELATIONSHIP,
  ...
  it('should throw a ValidationError if an invalid email address is provided as input', () => {
    expect(() => {
      new AboutYou(
        VALID_DOB,
        VALID_RELATIONSHIP,
  ...
  it('should strip illegal characters from fields which accept free text inputs', () => {
