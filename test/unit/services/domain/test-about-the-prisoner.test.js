...
describe('services/domain/about-the-prisoner', () => {
  ...
  it('should construct a domain object given valid input', () => {
    aboutThePrisoner = new AboutThePrisoner(
      VALID_FIRST_NAME,
      VALID_LAST_NAME,
      VALID_DOB_DAY,
      VALID_DOB_MONTH,
  ...
  it('should throw a ValidationError if invalid input', () => {
    expect(() => {
  ...
  it('should throw a ValidationError if an invalid date of birth is provided as input', () => {
    expect(() => {
      new AboutThePrisoner(
        VALID_FIRST_NAME,
        VALID_LAST_NAME,
  ...
  it('should strip illegal characters from otherwise valid data', () => {
