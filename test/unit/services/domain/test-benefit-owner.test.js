...
describe('services/domain/benefit-owner', () => {
  ...
  it('should throw a ValidationError if an invalid DOB day is provided as input', () => {
    expect(() => {
      new BenefitOwner(
        VALID_FIRST_NAME,
        VALID_LAST_NAME,
  ...
  it('should throw a ValidationError if an invalid DOB month is provided as input', () => {
    expect(() => {
      new BenefitOwner(
        VALID_FIRST_NAME,
        VALID_LAST_NAME,
