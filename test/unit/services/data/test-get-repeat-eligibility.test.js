...
describe('services/data/get-repeat-eligibility', () => {
  ...
  it('should return contact details from updated contact', () => {
    ...
    return mockGetRepeatEligibility(REFERENCE, DOB, ELIGIBILITYID).then(result => {
  ...
  it('should return contact details from the maskeed eligibility', () => {
    mockGetMaskedEligibility.mockResolvedValue(MASKED_ELIGIBILITY)
