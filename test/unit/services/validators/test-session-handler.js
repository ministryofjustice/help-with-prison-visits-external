...
describe('services/validators/session-handler validateSession', function () {
  describe('date-of-birth Session', function () {
  ...
  describe('prisoner-relationship Session', function () {
  ...
  describe('benefit Session', function () {
  ...
  describe('about-the-prisoner Session', function () {
  ...
  describe('about-you Session', function () {
  ...
  describe('journey-information Session', function () {
...
describe('services/validators/session-handler getErrorPath', function () {
...
describe('services/validators/session-handler clearSession', function () {
  const VALID_SESSION = {
    dobEncoded: VALID_ENCODED_DOB,
    relationship: VALID_RELATIONSHIP,
    benefit: VALID_BENEFIT,
