...
describe('routes/apply/new-eligibility/eligible-child', () => {
  const COOKIES = [
    'apvs-start-application=eyJub3dJbk1pbnV0ZXMiOjI2MzM1MjEwLjU5NDQ2NjY2OCwiZG9iRW5jb2RlZCI6IjExNDAxNzYwNyIsInJlbGF0aW9uc2hpcCI6InIxNCIsImJlbmVmaXQiOiJiMSIsImJlbmVmaXRPd25lciI6InllcyIsInJlZmVyZW5jZUlkIjoiNDI0MzcwMWVhYWM3NGRhNzBiYTg4ZmIyIiwiZGVjcnlwdGVkUmVmIjoiSDU3UFYxRCJ9',
  ]
  const COOKIES_EXPIRED = ['apvs-start-application=']
  const ROUTE = '/apply/first-time/new-eligibility/eligible-child'

  beforeEach(() => {
    jest.mock('../../../../../app/services/data/insert-eligible-child', () => mockInsertEligibleChild)
  ...
  describe(`POST ${ROUTE}`, () => {
    ...
    it('should respond with a 400 for invalid data', () => {
      mockEligibleChild.mockImplementation(() => {
