...
describe('routes/apply/new-eligibility/about-the-prisoner', () => {
  const COOKIES = [
    'apvs-start-application=eyJub3dJbk1pbnV0ZXMiOjI1OTQ4MDg2LjY0NDMsImRvYkVuY29kZWQiOiIxMTQwMTc2MDciLCJyZWxhdGlvbnNoaXAiOiJyNCIsImJlbmVmaXQiOiJiMSIsImJlbmVmaXRPd25lciI6InllcyJ9',
  ]
  const COOKIES_NOT_BENEFIT_OWNER = [
    'apvs-start-application=eyJub3dJbk1pbnV0ZXMiOjI1OTQ4MDk3LjE1MTI4MzMzNSwiZG9iRW5jb2RlZCI6IjExNDAxNzYwNyIsInJlbGF0aW9uc2hpcCI6InIxIiwiYmVuZWZpdCI6ImIxIiwiYmVuZWZpdE93bmVyIjoibm8ifQ==',
  ]
  ...
  describe(`POST ${ROUTE}`, () => {
    it('should persist data and redirect to first-time/about-you for valid data and benefit owner', () => {
      const newReference = 'NEWREF1'
      const newEligibilityId = 1234
      const newAboutThePrisoner = {}
      mockInsertNewEligibilityAndPrisoner.mockResolvedValue({
    ...
    it('should persist data and redirect to first-time/benefit-owner for valid data and not benefit owner', () => {
      const newReference = 'NEWREF1'
      const newEligibilityId = 1234
      const newAboutThePrisoner = {}
      mockInsertNewEligibilityAndPrisoner.mockResolvedValue({
    ...
    it('should persist data and redirect to /apply/first-time/new-eligibility?error=expired', () => {
      const newReference = 'NEWREF1'
      const newEligibilityId = 1234
      const newAboutThePrisoner = {}
      mockInsertNewEligibilityAndPrisoner.mockResolvedValue({
    ...
    it('should respond with a 400 for invalid data', () => {
      mockAboutThePrisoner.mockImplementation(() => {
