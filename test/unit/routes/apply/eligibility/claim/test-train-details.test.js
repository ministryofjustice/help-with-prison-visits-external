...
describe('routes/apply/eligibility/claim/train-details', () => {
  const COOKIES = [
  ...
  beforeEach(() => {
    ...
    jest.mock('../../../../../../app/services/domain/expenses/train-expense', () => mockTrainExpense)
  ...
  describe(`GET ${ROUTE}`, () => {
    ...
    it('should call the function to determine if claim is advance or not', () => {
  ...
  describe(`POST ${ROUTE}`, () => {
    ...
    it('should respond with a 400 if domain object validation fails.', () => {
      mockGetExpenseOwnerData.mockResolvedValue()
      mockTrainExpense.mockImplementation(() => {
