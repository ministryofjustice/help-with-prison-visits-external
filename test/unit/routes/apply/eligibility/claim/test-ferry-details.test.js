...
describe('routes/apply/eligibility/claim/ferry-details', () => {
  const COOKIES = [
  ...
  beforeEach(() => {
    ...
    jest.mock('../../../../../../app/services/domain/expenses/ferry-expense', () => mockFerryExpense)
  ...
  describe(`POST ${ROUTE}`, () => {
    ...
    it('should respond with a 400 if domain object validation fails.', () => {
      mockGetExpenseOwnerData.mockResolvedValue({})
      mockFerryExpense.mockImplementation(() => {
