...
describe('routes/apply/eligibility/claim/plane-details', function () {
  ...
  beforeEach(function () {
    ...
    jest.mock(
      '../../../../../../app/services/domain/expenses/plane-expense',
      () => mockPlaneExpense
    )
    jest.mock(
  ...
  describe(`POST ${ROUTE}`, function () {
    ...
    it('should respond with a 400 if domain object validation fails.', function () {
      mockGetExpenseOwnerData.mockResolvedValue({})
      mockPlaneExpense.mockImplementation(() => { throw new ValidationError() })
      return supertest(app)
        .post(ROUTE)
        .set('Cookie', COOKIES)
        .expect(400)
    ...
    it('should respond with a 500 if any non-validation error occurs.', function () {
      mockPlaneExpense.mockImplementation(() => { throw new Error() })
      return supertest(app)
        .post(ROUTE)
        .set('Cookie', COOKIES)
        .expect(500)
