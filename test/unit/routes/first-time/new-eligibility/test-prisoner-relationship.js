...
var route = proxyquire(
  '../../../../../app/routes/apply/new-eligibility/prisoner-relationship', {
...
describe('routes/apply/new-eligibility/prisoner-relationship', function () {
  ...
  describe(`POST ${ROUTE}`, function () {
    ...
    it('should redirect to benefits page if relationship is any value other than None of the above', function (done) {
