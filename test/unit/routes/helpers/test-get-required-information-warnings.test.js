...
const EXPENSES_TO_BE_ADDED = [
  { Status: REQUIRED_STATUS, fromInternalWeb: FROM_INTERNAL_WEB },
  { Status: REQUIRED_STATUS, fromInternalWeb: true },
]
...
describe('routes/helpers/get-required-information-warnings', () => {
  it('should return an empty array for no information required', () => {
    const result = addInformationHelper(
      OTHER_STATUS,
      OTHER_STATUS,
  ...
  it('should return a information about viewing messages', () => {
    const result = addInformationHelper(
      REQUIRED_STATUS,
      OTHER_STATUS,
      OTHER_DOCUMENT_STATUS,
  ...
  it('should return an a benefit information required messages', () => {
    const resultStatus = addInformationHelper(
      OTHER_STATUS,
      REQUIRED_STATUS,
      OTHER_DOCUMENT_STATUS,
      OTHER_STATUS,
    ...
    const resultDocument = addInformationHelper(
      OTHER_STATUS,
      OTHER_STATUS,
  ...
  it('should return a visit confirmation information required messages', () => {
    const resultStatus = addInformationHelper(
      OTHER_STATUS,
      OTHER_STATUS,
      OTHER_DOCUMENT_STATUS,
  ...
  it('should return an expenses information required message', () => {
    const result = addInformationHelper(
      OTHER_STATUS,
      OTHER_STATUS,
      OTHER_DOCUMENT_STATUS,
  ...
  it('should return a bank details are needed message', () => {
    const result = addInformationHelper(
      OTHER_STATUS,
      OTHER_STATUS,
      OTHER_DOCUMENT_STATUS,
