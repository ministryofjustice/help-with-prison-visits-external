...
describe('routes/index', () => {
  ...
  describe(`GET ${ASSISTED_DIGITAL_ROUTE}`, () => {
    const COOKIE_NAME = 'apvs-assisted-digital'
    const CASEWORKER_EMAIL = 'a@b.com'
    const COOKIE = { caseworker: CASEWORKER_EMAIL }

    it('should set the assisted digital cookie if the query paramater is passed and respond with a 302', () => {
    ...
    it('should not set the assisted digital cookie if the query paramater is not passed and respond with a 302', () => {
      return supertest(app)
        .get(ASSISTED_DIGITAL_ROUTE)
        .expect(response => {
