...
describe('views/helpers/display-helper', () => {
  ...
  it('should return the correct prisoner relationship display name given a valid value', () => {
  ...
  it('should return the correct expense name given a valid value', () => {
    const result = displayHelper.getExpenseDisplayName(VALID_EXPENSE_VALUE)
    expect(result).toBe(expenseTypeEnum.BUS.displayName)
  })

  it('should return the correct boolean for receipt required given a valid value', () => {
  ...
  it('should return the correct currency value given a valid integer or decimal number', () => {
  ...
  describe('zeroCostWarning', () => {
    const ADVANCE = true
    const RETRO = false
    const ZERO_COST = 0
    const COST = 2.5

    it('should give false when no warnings are needed', () => {
    ...
    it('should return true if the cost is zero or less and not one of the expections', () => {
