module.exports = {
  VISIT_CONFIRMATION: { documentType: 'VISIT-CONFIRMATION', title: 'Add visit confirmation form', guidingText: 'Provide the stamped form as evidence of your visit.', displayDataProtection: false },
  'working-tax-credit': { documentType: 'working-tax-credit', title: 'Working Tax credits or Child tax credit with disability documentation', guidingText: 'You must provide evidence of each page of your Working Tax credits or Child tax credit with disability documentation, upload one page at a time', displayDataProtection: true },
  'pension-credit': { documentType: 'pension-credit', title: 'Pension credit documentation', guidingText: 'You must provide evidence of each page of your Pension Credit documentation, upload one page at a time', displayDataProtection: true },
  hc2: { documentType: 'hc2', title: 'Health Certificate (HC2) documentation', guidingText: 'You must provide evidence of your Health Certificate (HC2) documentation', displayDataProtection: true },
