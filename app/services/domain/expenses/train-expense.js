...
class TrainExpense extends BaseExpense {
  constructor (cost, from, to, isReturn, ticketOwner, travelTime, isAdvanceClaim) {
    super(EXPENSE_TYPE.TRAIN.value, cost, travelTime, from, to, isReturn, null, null, ticketOwner)
