...
module.exports = (reference, eligibilityId, claimId, message, bankDetails, assistedDigitalCookie) => {
  const setTaskStatus = assistedDigitalCookie === 'teste2e@test.com' ? 'TEST' : false // logic for e2e tests
  return insertBankDetailsIfRequired(reference, eligibilityId, claimId, bankDetails).then(() => {
