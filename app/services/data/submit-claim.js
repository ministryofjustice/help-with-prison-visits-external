...
module.exports = (reference, eligibilityId, claimId, claimType, assistedDigitalCaseworker, paymentMethod) => {
  ...
  return db('Claim')
    ...
    .then(result => {
      ...
      return Promise.all([
        updateEligibility(reference, eligibilityId, dateSubmitted),
