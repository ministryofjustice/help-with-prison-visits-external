...
module.exports = function (router) {
  router.get('/first-time/eligibility/:referenceId/claim/:claimId/taxi', function (req, res) {
  ...
  router.post('/first-time/eligibility/:referenceId/claim/:claimId/taxi', function (req, res, next) {
    UrlPathValidator(req.params)
