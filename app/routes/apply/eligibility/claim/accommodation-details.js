...
module.exports = function (router) {
  router.get('/apply/:claimType/eligibility/:referenceId/claim/:claimId/accommodation', function (req, res) {
  ...
  router.post('/apply/:claimType/eligibility/:referenceId/claim/:claimId/accommodation', function (req, res, next) {
    UrlPathValidator(req.params)
