...
(function (window, $) {
  ...
  MojAutocomplete.prototype = {
    ...
    _createAutocomplete: function(){
      this.optionGroups = this.$select.children('optgroup')
      var selected = this.optionGroups.children(':selected'),
    ...
    _source: function(request, response){
      ...
      if (this._hasMatches(request.term)) {
        response(
          this.optionGroups.map(function() {
            var result = []
    ...
    _hasMatches: function (term) {
      ...
      this.optionGroups.each(function() {
    ...
    _autocompletechange: function(event, ui) {
      var $text = $(this),
          ...
          valid = false,
          optionGroups = $select.children('optgroup');
